...
* **TWE**: Yang Liu, Zhiyuan Liu, Tat-Seng Chua, Maosong Sun. "Topical Word Embeddings". AAAI (2015) [[PDF]](./papers/topic-modeling/AAAI15_TWE.pdf) :star::star::star:
...
* **DADT**: Yanir Seroussi, Fabian Bohnert, Ingrid Zukerman. "Authorship Attribution with Author-aware Topic Models". ACL(2012) [[PDF]](./papers/topic-modeling/P12-2052.pdf) :star::star::star::star:
...
* **TopicRNN**: Adji B. Dieng, Chong Wang, Jianfeng Gao, John William Paisley. "TopicRNN: A Recurrent Neural Network with Long-Range Semantic Dependency". ICLR(2017) [[PDF]](./papers/topic-modeling/ICLR17_TopicRNN.pdf) [[code]](https://github.com/dangitstam/topic-rnn) :star::star::star::star::star:
